...
execute if score @s spellbook.shock.victim matches 40.. as @e[tag=spellbook.shock.victim] run function recondite:item/lightning_elemental_spellbook/abilities/electric_shock/end
