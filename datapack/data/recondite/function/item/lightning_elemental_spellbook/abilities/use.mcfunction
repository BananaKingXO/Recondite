...
execute unless predicate recondite:is_sneaking as @s[scores={recondite.charge.cooldown=500..,recondite.lightning_spell.value=2}] run function recondite:item/lightning_elemental_spellbook/abilities/charge/spell
execute unless predicate recondite:is_sneaking as @s[scores={recondite.shock.cooldown=400..,recondite.lightning_spell.value=3}] run function recondite:item/lightning_elemental_spellbook/abilities/electric_shock/electric_shock
...
execute unless predicate recondite:is_sneaking as @s[scores={recondite.shock.cooldown=..399,recondite.lightning_spell.value=3}] run title @s actionbar {"text":"Spell under Cooldown "}
