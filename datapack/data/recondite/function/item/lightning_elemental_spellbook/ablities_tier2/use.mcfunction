execute unless predicate recondite:is_sneaking positioned ~ ~1.5 ~ positioned ^ ^ ^0.5 as @s[scores={spellbook.lightning.cooldown=200..,recondite.lightning_spell.value=1}] run function recondite:item/lightning_elemental_spellbook/ablities_tier2/lightning_strike/lightning_strike
...
execute unless predicate recondite:is_sneaking as @s[scores={recondite.static.cooldown=1200..,recondite.lightning_spell.value=4}] run function recondite:item/lightning_elemental_spellbook/ablities_tier2/static/static_footing
...
execute unless predicate recondite:is_sneaking as @s[scores={recondite.static.cooldown=..1199,recondite.lightning_spell.value=4}] run title @s actionbar {"text":"Spell under Cooldown "}
