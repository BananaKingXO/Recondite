...
run function recondite:crafting/craft_common_ink {loot:"recondite:item/common_ink"}
...
run function recondite:crafting/craft_uncommon_ink {loot:"recondite:item/uncommon_ink"}
...
run function recondite:crafting/craft_rare_ink {loot:"recondite:item/rare_ink"}
