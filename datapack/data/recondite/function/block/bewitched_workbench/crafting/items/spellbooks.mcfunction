...
run function recondite:block/bewitched_workbench/crafting/craft/special/craft_fire_book
...
if entity @e[type=item,distance=..1.5,tag=spellbook.bewitched_workbench.minecraft.book,scores={spellbook.bewitched_workbench.count=1}] \
run function recondite:block/bewitched_workbench/crafting/craft/special/craft_lightning_book