...
execute align xyz positioned ~.5 ~ ~.5 run summon item_display ~ ~0.5 ~ {item:{id:"minecraft:fletching_table",count:1,components:{"minecraft:item_model":"recondite:arcane_workbench"}},brightness:{block:15,sky:15},Tags:["recondite.arcane_workbench_display","smithed.entity","smithed.strict"]}
