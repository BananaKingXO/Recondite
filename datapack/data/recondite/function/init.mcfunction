...
scoreboard objectives add spellbook.fireball.cooldown dummy
scoreboard objectives add spellbook.fire_switch.cooldown dummy
scoreboard objectives add spellbook.lightning.cooldown dummy
scoreboard objectives add spellbook.wither.cooldown dummy
scoreboard objectives add spellbook.vine.cooldown dummy
scoreboard objectives add spellbook.fire_slash.cooldown dummy
scoreboard objectives add spellbook.lightning_switch.cooldown dummy
scoreboard objectives add spellbook.shock.cooldown dummy
...
scoreboard objectives add spellbook.fire_spell.value2 dummy
